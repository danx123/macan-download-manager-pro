...
class MainWindow(QMainWindow):
    ...
    def create_context_menu(self, pos):
        ...
        # Pastikan kita mengimpor partial di atas file
        from functools import partial
        ...
        remove_from_list.triggered.connect(
            partial(self.manager.remove_download, item.uid, delete_file=False)
        )
        remove_and_delete.triggered.connect(
            partial(self.manager.remove_download, item.uid, delete_file=True)
        )
        # --- AKHIR PERBAIKAN ---
    ...
    def apply_stylesheet(self):
        ...
        self.setStyleSheet("""
            ...
            QToolBar QLineEdit { padding: 4px; background-color: #2F2F2F; } /* Style khusus search bar */
