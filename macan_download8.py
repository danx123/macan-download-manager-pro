...
class MainWindow(QMainWindow):
    ...
    def create_tray_icon(self):
        ...
        show_action.triggered.connect(self.show_and_raise) # DIUBAH
        exit_action = tray_menu.addAction("Exit")
        exit_action.triggered.connect(self.quit_application) # DIUBAH
    ...
    def apply_stylesheet(self):
        self.setStyleSheet("""
            ...
            QDialog QLabel { color: white; } /* <<< BARU: Membuat label di dialog menjadi putih */
            ...
            QToolBar QLineEdit { padding: 4px; background-color: #FFFFFF; }
